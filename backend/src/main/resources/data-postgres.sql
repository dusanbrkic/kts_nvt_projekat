insert into zaposleni (ime, prezime, pol, datum_rodjenja, trenutna_plata, zaposlenje, putanja_slike, obrisan) values ('Perica', 'Peric', 0, '1990-01-01', 45000.0, 0, 'pera.jpg', false);
insert into sankeri (id) values(1);
