...
public class EditZonuTest {
	...
	public void commenceTesting(){
		...
		adminPage.dodajStoBtnClick();
		adminPage.noviStoDivDoubleClick();
		adminPage.setNazivStolaInput("astal za zivanca");
		adminPage.saveStoBtnClick();
		adminPage.saveZoneBtnClick();
