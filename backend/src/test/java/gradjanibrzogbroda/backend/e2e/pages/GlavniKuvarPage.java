...
public class GlavniKuvarPage {
	...
	public void jelovnikBtnClick(){jelovnikBtn.click();}
	public void jelaBtnClick(){jelaBtn.click();}
	public void newJeloBtnClick(){newJeloBtn.click();}
	public void pljeskavicaJeloRowRightClick(){actions.contextClick(pljeskavicaJeloRow);}
	public void opisBtnClick(){opisBtn.click();}
	public void editBtnClick(){editBtn.click();}
	public void deleteBtnClick(){deleteBtn.click();}
	public void setNazivInput(String naziv){nazivInput.sendKeys(naziv);}
	public void setCenaInput(Double cena){cenaInput.sendKeys(cena.toString());}
	public void setVremeInput(Integer vreme){vremeInput.sendKeys(vreme.toString());}
	public void setOpisJela(String opis){opisJela.sendKeys(opis);}
	public void saveBtnClick(){saveBtn.click();}
	public void changePassBtnClick(){changePassBtn.click();}
	public void setPassInput(String pass){passInput.sendKeys(pass);}
	public void setRptPassInput(String pass){rptPassInput.sendKeys(pass);}
	public void confirmPassChangeBtnClick(){confirmPassChangeBtn.click();}
